...
function cgp_banktransfer_config() {

    $configarray = array(
        "FriendlyName" => array( "Type" => "System", "Value" => "Card Gate - Bank Transfer" ),
...
function cgp_banktransfer_link( $params ) {
    return cgp_form( $params, 'banktransfer' );
}
