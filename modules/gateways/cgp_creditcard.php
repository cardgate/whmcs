...
function cgp_creditcard_config() {

    $configarray = array(
        "FriendlyName" => array( "Type" => "System", "Value" => "Card Gate - Credit Card" ),
...
function cgp_creditcard_link( $params ) {
    return cgp_form($params, 'creditcard');
}
