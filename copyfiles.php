...
$src = '../modules/gateways/cgp_afterpay.php';
$dst = 'modules/gateways/cgp_afterpay.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../modules/gateways/cgp_billink.php';
$dst = 'modules/gateways/cgp_billink.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../modules/gateways/cgp_bitcoin.php';
$dst = 'modules/gateways/cgp_bitcoin.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../modules/gateways/cgp_giftcard.php';
$dst = 'modules/gateways/cgp_giftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../modules/gateways/cgp_idealqr.php';
$dst = 'modules/gateways/cgp_idealqr.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../modules/gateways/cgp_klarna.php';
$dst = 'modules/gateways/cgp_klarna.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../modules/gateways/cgp_paysafecard.php';
$dst = 'modules/gateways/cgp_paysafecard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../modules/gateways/cgp_paysafecash.php';
$dst = 'modules/gateways/cgp_paysafecash.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../modules/gateways/cgp_przelewy24.php';
$dst = 'modules/gateways/cgp_przelewy24.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
